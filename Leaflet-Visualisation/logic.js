...
legend.onAdd = function(map) {
  ...
  div.innerHTML += '<i style="background: #89FF89"></i><span>< 10</span><br>';
  div.innerHTML += '<i style="background: #FFFF00"></i><span>< 30</span><br>';
  div.innerHTML += '<i style="background: #FFed42"></i><span>< 50</span><br>';
  div.innerHTML += '<i style="background: #FFA500"></i><span>< 70</span><br>';
